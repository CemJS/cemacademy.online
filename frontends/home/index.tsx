...
front.loader = () => {
  ...
  Static.skillsResult = [
    "Эксклюзивный доступ к всем известным и проверенным методам зарабатывания на криптовалюте, включая листинги новых монет, участие в seed-раундах проектов, арбитраж и маржинальную торговлю.",
    "Глубокое понимание ключевых концепций, таких как блокчейн, современная инфраструктура финансов и стратегическое положение криптовалют в развивающейся экономике.",
    "Тщательно разработанный комплекс знаний по инвестированию, включая методики вложений с различным уровнем риска – от консервативных до агрессивных стратегий.",
    "А также возможность начать получать доход в короткие сроки, вооружившись практическими навыками и знаниями от ведущих экспертов.",
    "Станьте архитектором собственного финансового будущего с нашим курсом, который не просто обучает, но и инвестирует в ваш успех"
  ];
  Static.callsResult = [
    "Ваш главный результат",
    "Вы начнете свое обучение с нуля и постепенно, подробно изучая все нюансы, достигнете конечной цели. Вы получите глубокое понимание механизмов функционирования крипторынка и найдете свое место в крипте, выбрав формат участия, который будет соответствовать вашим финансовым возможностям, предпочтениям в уровне риска и желаемому темпу развития.",
    "У каждого будет индивидуальный финансовый результат."
  ];
  return;
};
